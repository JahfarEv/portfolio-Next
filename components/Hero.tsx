    ...
    <div className="h-[100vh] bg-cover bg-center">
      <div className="w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[3rem] h-full items-center">
        <div>
          ...
          Hi! I’m Jahfar Ali, a dedicated MERN Stack Developer with a knack for crafting seamless and responsive web applications. Explore my work, dive into my projects, and see how I turn ideas into functional digital experiences. Let's build something amazing together!
          </p>
