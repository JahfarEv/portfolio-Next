...
//         <div className="nav-link-mobile" onClick={() => handleScroll('hero')}>SERVICES</div>
//         <div className="nav-link-mobile" onClick={() => handleScroll('about')}>ABOUT</div>
//         <div className="nav-link-mobile" onClick={() => handleScroll('project')}>PROJECT</div>
//         <div className="nav-link-mobile" onClick={() => handleScroll('home')}>HOME</div>
//         <div className="nav-link-mobile" onClick={() => handleScroll('blog')}>BLOG</div>
//         <div className="nav-link-mobile" onClick={() => handleScroll('contact')}>CONTACT</div>
//       </div>
...
const MobileNav = ({ nav, closeNav }: Props) => {
  ...
  const handleScroll = (id: string) => {
    ...
    if (element) {
      element.scrollIntoView({ behavior: "smooth" });
      closeNav(); // Close the mobile menu after scrolling
    }
  };
