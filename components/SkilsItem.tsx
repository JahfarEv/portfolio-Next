...
// const SkilsItem = ({ service, skill1, skill2, skill3, skill4, skill5, skill6, skill7, skill8,skill9,skill10,skill11 }: Props) => {
//   const skills = [skill1, skill2, skill3, skill4, skill5, skill6, skill7,skill8,skill9,skill10,skill1];
...
const SkilsItem = ({
  ...
  return (
    <div className="mb-[4rem] md:mb-[8rem] w-full">
      <div className="text-center border  border-gray-600 rounded-3xl">

        <span className="inline-block px-4 text-teal-400 font-bold text-[18px] w-full p-3">
          {service}
        </span>

        {/* ✅ FIX HEIGHT HERE ONLY */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 w-full md:mt-5 justify-center min-h-[340px] ">
          {skills.map((skill, index) => (
            <div
              key={index}
              className="flex flex-col items-center mx-auto mb-5 text-center"
            >
              <svg
                width="30"
                height="30"
              ...
              >
                <path
                  d="M16.1609 10.1086L11.3309 14.9386C11.1909 15.0786 11.0009 15.1586 10.8009 15.1586C10.6009 15.1586 10.4109 15.0786 10.2709 14.9386L7.85086 12.5186"
                  stroke="#ffffff"
                  strokeWidth="1.5"
                />
              </svg>

              {/* ✅ Prevent text wrap height jump */}
              <p className="font-mono text-lg font-bold text-white text-center break-words">
                {skill}
              </p>
              <p className="text-gray-300">Experienced</p>
            </div>
