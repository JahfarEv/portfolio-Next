...
const SkilsItem = ({ service, skill1, skill2, skill3, skill4 }: Props) => {
  return (
    <div className="mb-[4rem] md:mb-[8rem] grid">
      <span className="px-[2rem] text-teal-400 py-[0.9rem] font-bold text-[18px] border-[2px] border-teal-400">
        {service}
      </span>
      <h1 className="mt-[2rem] font-semibold capitalize mb-[1rem] text-[20px] sm:text-[25px] md:text-[30px] text-white"></h1>
      ...
      <span className="px-[2rem] text-teal-400 py-[0.9rem] font-bold text-[18px] border-[2px] border-teal-400 rounded-3xl">
        <div className="grid md:grid-cols-2 gap-10 w-full md:mt-5 justify-center ">
          {/* <div className="border rounded-3xl w-full h-full flex flex-col items-center justify-center my-5 md:my-0 "> */}
          <div className="md:grid md:grid-cols-3 w-full">
            <div className="flex justify-center items-center mx-auto max-w-[200px] min-w-[150px] mb-5">
              <svg
                width="30px"
                height="30px"
                viewBox="0 0 24 24"
